...
LINKS = {
 ...
 "Expectancy":               ["Ergodicity", "Variance drain"],
 "Risk of ruin":             ["Ergodicity", "Path dependence"],
 "Sequence risk":            ["Path dependence"],
 "Volatility":               ["Variance drain"],
 "Multiple testing":         ["Type I / Type II error"],
 "Pairs trading":            ["Cointegration", "Half-life"],
 "Sharpe ratio":             ["Information ratio"],
 "Tokenomics":               ["Fully diluted valuation", "Circulating supply"],
 "Liquidation":              ["Liquidation price"],
 "MEV":                      ["Sandwich attack", "Priority fee"],
 "Gas":                      ["Priority fee"],
 "Commission":               ["Maker / taker"],
 "Limit order":              ["Post-only order"],
 "Best execution":           ["NBBO"],
 "Requote":                  ["Last look"],
 "Iceberg order":            ["Hidden order"],
 "Trading journal":          ["Decision journal", "Pre-mortem"],
 "Base rate neglect":        ["Outside view"],
 "CFD":                      ["Spread bet"],
 "ETF":                      ["ETN"],
}
